    ...
    <div className="flex flex-col w-full relative">
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-zinc-400 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto mb-4">
          ...
          <p className="text-zinc-500 text-sm sm:text-base leading-relaxed max-w-2xl mx-auto mb-10">
            Onde muitos veem vácuo, nós vemos foco. Nossa missão é entregar resultados impecáveis
            com visão autoral e execução precisa.
          </p>
      ...
      >
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Vamos criar juntos?</h2>
          <p className="text-zinc-400 text-base sm:text-lg mb-10 max-w-xl mx-auto">
            Entre em contato e conte sobre o seu projeto.
